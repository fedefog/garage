...
<?php get_header(); ?>
  ...
  <section id="main-content">
    <div class="row">
      <div class="col-md-12">
        ...
        <?php $posts_options = array( 'numberposts' => 1, 'orderby' => 'post_date' );
  ...
  <section id="old-posts">
    <div class="row top-posts">
      <div class="col-md-4">
        <div class="title-sidebar"> <?php if (is_singular( 'highlights' )): echo 'Ultimos Highlights'; else : echo 'Videos Anteriores'; endif; ?></div>
        <!-- / title sidebar -->
    ...
    <div class="row">
      <div class="col-md-12 load-container"> <a class="load-more fade-fx" href="" title="Cargar Más"></a> </div>
      <!-- / col 12 -->
    </div>
    <!-- / row -->
  </section>
