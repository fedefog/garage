$(document).ready(function(){
    ...
    /*CONTENIDO sfafsafasfasf*/

    $('.contenido.menu-item-has-children .dropdown-toggle').click(function (event){
        event.preventDefault();
        $('#menu-item-17.dropdown').toggleClass("open");
    });

    $('#menu-ft .contenido.menu-item-has-children .dropdown-toggle').click(function (event){
        event.preventDefault();
